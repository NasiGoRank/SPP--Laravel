<div>
  <section class="row">
    ...
    <div class="col-12 col-lg-3">
      ...
      <div class="card">
        <x-apexcharts.pie-chart chartTitle="Status Pembayaran Bulan Ini" chartID="chart-pie-payment-status"
          :series="$charts['pieChart']['paymentStatus']['series']" :labels="$charts['pieChart']['paymentStatus']['labels']"
          :colors="['#4fbe87', '#ff7976']" />
      </div>
    </div>
  </section>
</div>
