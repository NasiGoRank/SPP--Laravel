        ...
        <div class="modal-body">
          <form wire:submit="edit">
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6">
                <x-forms.input-with-icon wire:model.blur="form.phone_number" label="Nomor Telepon"
                  name="form.phone_number" type="text" placeholder="Masukan nomor telepon.." icon="bi bi-telephone" />
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="mb-3">
                <x-forms.select-with-icon icon="bi-journal-bookmark" label="Program SPP" name="school_program_id"
                  wire:model="form.school_program_id" id="school_program_id">
