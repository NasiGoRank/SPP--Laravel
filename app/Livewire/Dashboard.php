...
class Dashboard extends Component
{
    ...
    public function render(): View
    {
        ...
        $paidCount = Student::whereHas('cashTransactions', function ($q) use ($startOfMonth, $endOfMonth) {
            $q->whereBetween('date_paid', [$startOfMonth, $endOfMonth]);
        })->count();

        $totalStudents = Student::count();

        $notPaidCount = $totalStudents - $paidCount;
        // -------------------------------------------------------
